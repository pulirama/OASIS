...
class login extends JFrame implements ActionListener {
    ...
    login() {
        ...
        passLabel.setFont(new Font("Times New Roman", Font.PLAIN, 40));
        ...
        newPanel = new JPanel(new GridLayout(2, 2, 0, 1));
...
class OnlineTestBegin extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand().equals("Save For Later")) {
            ...
            bk.setBounds(700, 90 + 30 * x, 100, 30);
    ...
    void set() {
        ...
        if (current == 0) {
            l.setText("1: JDK stands for ____.");
            l.setFont(new Font("Times New Roman", Font.PLAIN, 20));
            jb[0].setText("Java deployment kit");
            jb[1].setText("Java development kit");
            jb[2].setText("JavaScript deployment kit");
            jb[3].setText("none");
            jb[0].setFont(new Font("Times New Roman", Font.PLAIN, 20));
            jb[1].setFont(new Font("Times New Roman", Font.PLAIN, 20));
            jb[2].setFont(new Font("Times New Roman", Font.PLAIN, 20));
            jb[3].setFont(new Font("Times New Roman", Font.PLAIN, 20));
        }
        if(current==1)
        {
            l.setText("2: What makes the Java platform independent?");
            l.setFont(new Font("Times New Roman", Font.PLAIN, 20));
